...
(function(factory) {
    ...
    MagnificPopup.prototype = {
        ...
        open: function(data) {
            ...
            if (mfp.st.fixedBgPos === !1 || (mfp.st.fixedBgPos === 'auto' && !mfp.fixedContentPos)) {
                mfp.bgOverlay.css({
        ...
        _close: function() {
            ...
            if (mfp.st.showCloseBtn && (!mfp.st.closeBtnInside || mfp.currTemplate[mfp.currItem.type] === !0)) {
        ...
        appendContent: function(newContent, type) {
            ...
            if (newContent) {
                if (mfp.st.showCloseBtn && mfp.st.closeBtnInside && mfp.currTemplate[type] === !0) {
...
(function(global, factory) {
    ...
    function mapToStyles(_ref2) {
        ...
        var _ref4 = roundOffsets === !0 ? roundOffsetsByDPR({
            x: x,
            y: y
        }, getWindow(popper)) : {
            x: x,
    ...
    class Tab extends BaseComponent {
        ...
        _activate(element, relatedElem) {
            ...
            const complete = () => {
                ...
                this._toggleDropDown(element, !0);
        ...
        _deactivate(element, relatedElem) {
            ...
            const complete = () => {
                ...
                this._toggleDropDown(element, !1);
...
(function(factory) {
    ...
    var defaults = {
        ...
        toggle: {
            ...
            touchSupport: (typeof Modernizr === 'undefined') ? !1 : Modernizr.touchevents,
    ...
    HideShowPassword.prototype = {
        ...
        prepareOptions: function(options, base) {
            ...
            if (options.enable) {
                ...
                if (!$.isArray(options.toggle.attachToKeyCodes)) {
                    if (options.toggle.attachToKeyCodes === !0) {
        ...
        updateElement: function() {
            if (!this.options.enable || this.isType()) return !1;
        ...
        wrapElement: function(options) {
            ...
            if (!this.wrapperElement.length) {
                ...
                if (enforceWidth === !0) {
                    enforceWidth = (this.wrapperElement.outerWidth() === targetWidth) ? !1 : targetWidth
                }
                if (enforceWidth !== !1) {
